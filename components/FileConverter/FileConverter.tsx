    ...
    <div className="mx-auto flex w-full max-w-3xl flex-col gap-8 py-12">
      <header className="space-y-3 text-center sm:text-left">
        ...
        <p className="text-pretty text-zinc-600 dark:text-zinc-400">
          Elige formato de salida: la optimización es automática (similar a
          TinyPNG: busca un archivo más liviano manteniendo buena apariencia).
          Varios archivos a la vez; con varios resultados puedes bajar un ZIP.
        </p>
      </header>
